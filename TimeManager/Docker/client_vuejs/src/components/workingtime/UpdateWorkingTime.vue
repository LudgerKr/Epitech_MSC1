...
export default {
  ...
  mounted() {
    axios.all([
      axios.get('http://13.68.159.231:4001/api/manager/workingtimes/' + this.$router.currentRoute.params.workingtime_id, config),
  ...
  methods: {
    edit() {
      axios.put('http://13.68.159.231:4001/api/admin/workingtimes/'  + this.$router.currentRoute.params.workingtime_id, {
        "workingtime": {

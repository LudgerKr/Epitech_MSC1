...
export default {
  ...
  mounted () {
    axios.all([
      axios.get('http://13.68.159.231:4001/api/manager/clocks/' + this.$router.currentRoute.params.clock_id, config),
  ...
  methods: {
    ...
    edit() {
      axios.put('http://13.68.159.231:4001/api/manager/clocks/' + this.clock.id, {
        "clock": {
